...
AOI = {
    "type": "Polygon",
    "coordinates": [[
        [-122.45, 37.75],  # Southwest corner (lon, lat)
        [-122.45, 37.80],  # Northwest corner
        [-122.40, 37.80],  # Northeast corner
        [-122.40, 37.75],  # Southeast corner
...
MAX_GSD = 3.5          # Max ground sample distance in meters
SCENE_LIMIT = 10       # Max number of scenes to return
