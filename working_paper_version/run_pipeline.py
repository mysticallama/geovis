...
BBOX = [36.0559, 49.8812, 36.4049, 50.1058]   # Example: Kharkiv

# ── Date range for ACLED ─────────────────────────────────────────────────────
ACLED_START_DATE = "2025-10-01"   # Inclusive start (YYYY-MM-DD)
ACLED_END_DATE   = "2025-10-14"   # Inclusive end   (YYYY-MM-DD)
